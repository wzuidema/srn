...
encoding_layer = Encoding_Layer(hidden_layer.activations, weights_hid_enc, weights_enc_out)
	
encoding_layer.calc_activations()
encoding_layer.add_bias()
...
#		print output_layer.weights
		...
		encoding_layer = Encoding_Layer(hidden_layer.activations, encoding_layer.weights, output_layer.weights)
